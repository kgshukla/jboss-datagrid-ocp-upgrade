...
image::images/cm-orig-cache.png[OldCacheDef, 600, 480]

to 

image::images/cm-new-cache.png[NewCacheDef, 600, 480]

2. Change hot rod server from
image::images/cm-old-hotrod-server.png[OldHotRod, 600, 480]

to 

image::images/cm-new-hotrod-server.png[OldHotRod, 600, 480]
